...
Handles spatio-temporal data with/as

- raster cubes (3 dimension)
- raster hypercubes (4 & more dimension)
- vector hypercubes
- raster non-regular grids
...
```{r 3-grids, echo = FALSE, cache = TRUE, px = 200, fig.cap="Grid formats allowed as `stars`-object [@R-stars]", fig.show = "hold", out.width = "50%"}
